...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\textbf{SQRT} &  \href{https://youtu.be/naNeYgvJVP0}{SQRT}  & \textbf{ABS} &  \href{https://youtu.be/bMePNuQysqU}{ABS}  \\\hline
		\textbf{NEG} &  \href{https://youtu.be/NKX-tBirX9k}{NEG}  & \textbf{CEQ} &  \href{https://youtu.be/9QW3dhkLjDo}{CEQ}  \\\hline
		\textbf{CLT} &  \href{https://youtu.be/1Ttfm08w3jI}{CLT} & \textbf{CLE} &  \href{https://youtu.be/dkqRH6RjpQI}{CLE}   \\\hline
		\textbf{CVTSW}  &  \href{https://youtu.be/jgjc1qbvtyQ}{CVTSW}  & \textbf{CVTWS} &  \href{https://youtu.be/USTwqtiWqRc}{CVTWS} \\\hline
	\end{tabular}
	\caption{Funcionamento das operações da ULA.}
