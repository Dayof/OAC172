...
Foi obtido 7 elementos lógicos, sendo que teve 9.761 ns como maior tempo de atraso. Já na versão síncrona foi obtido 7 elementos lógicos, sendo a frequência máxima de operação de 6.787MHz.

O arquivo de interface \textit{TopDE.v} foi incluso no projeto, sintetizado e testado como é mostrado no link \url{?}.
