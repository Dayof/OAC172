...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\textbf{MADD} &  \href{https://youtu.be/bFgy3tbd6W0}{MADD}  & \textbf{MADDU} &  \href{https://youtu.be/bFgy3tbd6W0}{MADDU} \\\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\textbf{MULS} &  \href{https://youtu.be/IZqVV-iU26Y}{MULS} & \textbf{DIVS} &  \href{}{DIVS} \\\hline
