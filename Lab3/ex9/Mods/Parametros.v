...
/* Campo OPCODE */
    ...
    OPCFLT      = 6'h11,
	 OPCMUL		 = 6'h12,					 // Para o MUL
	 /*OPCODE para operacoes da FPU*/
...
//    END_KDATA           = 32'h900007FF, 	// 512 words
    ...
    END_VGA                     = 32'hFF012C00,  // 320 x 240 = 76800 bytes
    ...
    SD_INTERFACE_CTRL           = 32'hFFFF0454,         // Informações de controle da interface do cartão SD [1 byte]
	 ...
	 IRDA_DECODER_ADDRESS		 = 32'hFFFF049C,
